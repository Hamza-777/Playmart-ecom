...
const loginToProceed = () => toast.info('Please login to perform this action!', {
    position: "top-center",
    autoClose: 3000,
    hideProgressBar: false,
    closeOnClick: true,
...
const passwordsNotSame = () => toast.error('Passwords do not match!', {
    position: "top-center",
    autoClose: 3000,
    hideProgressBar: false,
    closeOnClick: true,
...
const notFound = () => toast.error('No such user exists!', {
    position: "top-center",
    autoClose: 3000,
    hideProgressBar: false,
    closeOnClick: true,
...
const unauthorized = () => toast.error('Authorization denied! Wrong credentials.', {
    position: "top-center",
    autoClose: 3000,
    hideProgressBar: false,
    closeOnClick: true,
